...
from experimentalWindForces_2D import *
...
def main(aimName, evtName, getRV):  # noqa: C901, N803, D103, PLR0915
    ...
    #######################################################
    if aim_data['GeneralInformation']['name'] == '2D_MSA' :
        # 2D_MSA is treated as a dedicated name. This minimizes the modifications required
        # to the original file.
        main2D(aimName,evtName,getRV)
        return
    ########################################################
    ...
    plt.plot(tvec, F_sim[9 , :, 0] / 1000,lw=1)
    if case == "timeHistory":
